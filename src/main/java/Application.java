public class Application {
    /**
     * This class contains a main method that allows you to manually test 
     * the Comparisons lab functionality.
     * No changes you make here affect the test case results. You must still 
     * run & pass the test cases.
     * All implementation code should be written in the Lab class.
     *
     * The Lab methods like isEqual, notEqualTo, etc should produce 
     * true or false values depending on the numbers
     * provided.
     */
